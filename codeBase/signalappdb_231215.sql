...
INSERT INTO `complains` (`Id`, `Description`, `Status`, `MenuComplainTypeId`, `TelephoneUserId`, `ComplainDate`, `ResolvedDate`, `Remarks`, `ActionTaken`, `ResolvedBy`, `AllPhoneInfoID`) VALUES
	...
	(99, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(100, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(101, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(102, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(103, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(104, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(105, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(106, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(107, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(108, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(109, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(110, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(111, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(112, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(113, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(114, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(115, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 2),
	(116, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 6),
	(117, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 6),
	(118, 'h3', 'Pending', 5, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 6),
	(119, 'h3', 'Pending', 4, 6, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 6),
	(120, 'h3', 'Pending', 4, 7, '2015-12-22 01:24:03', '0000-00-00 00:00:00', NULL, NULL, NULL, 6);
...
CREATE TABLE IF NOT EXISTS `maildata` (
  ...
  `MailTo` int(11) DEFAULT NULL,
  `MailFrom` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK1_mailTo` (`MailTo`),
  KEY `FK2_MailFrom` (`MailFrom`),
  CONSTRAINT `FK1_mailTo` FOREIGN KEY (`MailTo`) REFERENCES `stations` (`ID`),
  CONSTRAINT `FK2_MailFrom` FOREIGN KEY (`MailFrom`) REFERENCES `stations` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=latin1;

-- Dumping data for table signalappdb.maildata: ~15 rows (approximately)
DELETE FROM `maildata`;
/*!40000 ALTER TABLE `maildata` DISABLE KEYS */;
INSERT INTO `maildata` (`ID`, `MailID`, `MailDescription`, `DateArrival`, `DateDeparture`, `MailTo`, `MailFrom`) VALUES
	(1, 'MID0001', 'DHK to CTG', '2015-11-24', '0000-00-00', NULL, NULL),
	(2, 'MID0002', 'CTG to DHK', '2015-11-24', '0000-00-00', NULL, NULL),
	(3, 'MID0003', 'CTG to BOG', '2015-11-24', '0000-00-00', NULL, NULL),
	(4, 'MID0004', 'DHK to DHK', '2015-11-24', '0000-00-00', NULL, NULL),
	(5, 'MID0005', 'BOG to DHK', '2015-11-24', '0000-00-00', NULL, NULL),
	(6, 'MID0006', 'Jess to DHK', '2015-11-24', '0000-00-00', NULL, NULL),
	(7, 'MID0007', 'BOG to DHK', '2015-11-24', '0000-00-00', NULL, NULL),
	(8, 'MID0007', 'BOG to RAJ', '2015-11-24', '0000-00-00', NULL, NULL),
	(9, 'MID0008', 'DHK to Saidpur', '2015-11-24', '0000-00-00', NULL, NULL),
	(10, 'MID0009', 'Saidpur to Rangpur', '2015-11-24', '0000-00-00', NULL, NULL),
	(11, 'MID00010', 'RAJ to CTG', '2015-11-24', '0000-00-00', NULL, NULL),
	(12, 'yyyy', 'No', '2015-12-23', '2015-12-24', 1, 2),
	(13, '8ui', 'ghsdsd', '2015-12-16', '2015-12-23', 2, 1),
	(14, '8ui', 'ghsdsd', '2015-12-16', '2015-12-23', 2, 1),
	(15, '566', 'asdasd', '2015-12-23', '2015-12-23', 3, 1);
...
-- Dumping structure for table signalappdb.stations
...
-- Dumping data for table signalappdb.stations: ~3 rows (approximately)
