...
namespace SignalSystemApp.Models.Equipment
{
    public class EquipmentDetails
    {
        ...
        public List<EquipmentDetails> GetEquipmentList()
        {
            ...
            string query = "select equipemntdescription.id,equipemntdescription.typeid,equipemntdescription.amount,equipemntdescription.description,equipmnttype.typename from equipemntdescription,equipmnttype where equipemntdescription.typeid=equipmnttype.id";
